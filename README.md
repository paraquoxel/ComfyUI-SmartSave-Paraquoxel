...
\* \*\*Hybrid Saving:\*\* Use it as a preview node and click to save manually, or enable auto\_save to write directly to your disk.
...
1\. Open your terminal and navigate to your ComfyUI custom\_nodes folder:
